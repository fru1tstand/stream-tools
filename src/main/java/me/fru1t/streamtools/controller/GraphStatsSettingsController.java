...
public class GraphStatsSettingsController extends SettingsController<GraphStatsSettings> {
        ...
        statistic.setConverter(new StringConverter<Statistic>() {
            ...
            public Statistic fromString(String string) {
                for (Statistic statistic : Statistic.values()) {
                    if (statistic.getDisplayString().equals(string)) {
                        return statistic;
                    }
                }
    ...
    protected void refresh() {
        ...
        // Time Axis
        timeAxis.setSelected(currentSettings.getTimeAxis().getEnabled());
        ...
        timeAxisTextBold.setSelected(currentSettings.getTimeAxis().getTextBold());
        timeAxisTextItalic.setSelected(currentSettings.getTimeAxis().getTextItalic());

        // Fixed Value Axis
        fixedValueAxis.setSelected(currentSettings.getFixedValueAxis().getEnabled());
        ...
        fixedValueAxisTextBold.setSelected(currentSettings.getFixedValueAxis().getTextBold());
        fixedValueAxisTextItalic.setSelected(currentSettings.getFixedValueAxis().getTextItalic());
    }
}
